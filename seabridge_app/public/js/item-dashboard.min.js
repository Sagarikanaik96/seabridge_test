...
function t(t,a){
	...
	//this.content=$(frappe.render_template("item_dashboard_list_end")).appendTo(this.parent),this.result=this.content.find(".result"),
