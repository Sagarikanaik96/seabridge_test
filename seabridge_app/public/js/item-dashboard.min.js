...
function t(t,a){
	...
	this.content.on("click",".btn-status",function(){
		//console.log("status-------------"t($(this),"Add"))
		console.log("status-------------",this)
		console.log("status-------------")
		//var name = ".btn-payy".getAttribute('name');
		var check=document.getElementById("btn-status").attributes["name"].value;
		//document.getElementById("btn-submit").style.display="none";
		console.log("name-------------",check)
		get_paid_invoices(check)
	...
	//$("<span class='text-muted small'>  abcd </span>").appendTo(this.result)}})
		//console.log("count-------------",this.max_count)
	    else{
