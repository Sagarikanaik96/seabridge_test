...
frappe.templates.item_dashboard='<div>  <div class="result">  </div>  <div class="more hidden" style="padding: 15px;">   <a class="btn btn-default btn-xs btn-more">More</a>  </div> </div>',frappe.templates.item_dashboard_list='<style>input{border: none;background: transparent;}.button-sbt {background-color: #008CBA;}.button-apr {background-color: #4CAF50;}.button {border: none; color: white; padding: 6px 6px;text-align: center;text-decoration: none;display: inline-block;font-size: 10px;margin: 2px 2px;cursor: pointer;}</style><div class="dashboard-list-item">   <div class="row"><div class="col-sm-1 small" style="margin-top: 8px;"><center><input type="checkbox" id="vehicle1" name="chcb1" value="Bike"></center></div><div class="col-sm-2 small" style="margin-top: 8px;"><b>Vendor</b></div><div class="col-sm-1 small" style="margin-top: 8px;"><b>Inv#</b></div> <div class="col-sm-1 small" style="margin-top: 8px;text-align:right;"><b>PO$ </b> </div>  <div class="col-sm-1 small" style="margin-top: 8px;text-align:right;"><b>Inv$</b></div><div class="col-sm-1 small" style="margin-top: 8px;text-align:right;"><b> Budget </b></div><div class="col-sm-1 small" style="margin-top: 8px;">  <b>PO Date</b>  </div><div class="col-sm-1 small" style="margin-top: 8px;"> <b> Invoice Date </b> </div><div class="col-sm-1 small" style="margin-top: 8px;"> <b> Match ? </b></div><div class="col-sm-1 small" style="margin-top: 8px;">  <b>Pending With  </b></div><div class="col-sm-1 small" style="margin-top: 8px;"><b>Status</b></div>   </div></div>{% for d in data %}  <div class="dashboard-list-item">   <div class="row"> <div class="col-sm-1 small" style="margin-top: 8px;"><center><input type="checkbox" id="chcb2" name="chcb2" value="Bike" class="btn-check"></center></div>   <div class="col-sm-2 small" style="margin-top: 8px;">     <a data-type="supplier" data-name="{{ d.supplier }}">{{ d[1] }}</a>    </div>    <div class="col-sm-1 small" style="margin-top: 8px;">          <a data-type="purchase_invoice"       data-name="{{ d.name }}" href="/desk#Form/Purchase%20Invoice/{{ d[0] }}"><input type="text" id="inv" name="inv" value={{ d[0] }}></a>      </div>  <div class="col-sm-1 small" style="margin-top: 8px;text-align:right;" id="inv">  {{ d[5] }}  </div>     <div class="col-sm-1 small" style="margin-top: 8px;text-align:right;"> {{ d[2]}} </div>    <div class="col-sm-1 small" style="margin-top: 8px;text-align:right;">  {{ d[9] }}  </div><div class="col-sm-1 small" style="margin-top: 8px;">  {{d[6]}}  </div> <div class="col-sm-1 small" style="margin-top: 8px;">  {{ d[3] }}  </div><div class="col-sm-1 small" style="margin-top: 8px;">  {%if d[7]==1%}Y{%else%}N{%endif%}  </div> <div class="col-sm-1 small" style="margin-top: 8px;">  {{ d[8] }}  </div><div class="col-sm-1" style="margin-top: 8px;text-align:left;"> </a>          <button  class="btn btn-default btn-xs btn-add" data-warehouse="{{ d.warehouse }}">{{d[4]}}</a>    </div>    </div>  </div> {% endfor %} <center><table><tr><td><div><button  class="btn btn-default btn-xs btn-submit  button-sbt button">Submit</a>    </div></td><td><div>&nbsp;<button  class="btn btn-default btn-xs btn-approve button-apr button">Approve</a>    </div></td></tr></center>',
