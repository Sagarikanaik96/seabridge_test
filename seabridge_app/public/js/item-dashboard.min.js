...
frappe.templates.item_dashboard='<div>  <div class="result">  </div>  <div class="more hidden" style="padding: 15px;">   <a class="btn btn-default btn-xs btn-more">More</a>  </div> </div>',frappe.templates.item_dashboard_list='<style>input{border: none;background: transparent;}.button-sbt {background-color: #008CBA;}.button-apr {background-color: #4CAF50;}.button {border: none; color: white; padding: 6px 6px;text-align: center;font-size: 10px;margin: 2px 2px;}div.b {word-wrap: break-word;}</style><div class="dashboard-list-item">   <div class="row"><div class="col-sm-1 small" style="margin-top: 8px;"><center><input type="checkbox" id="vehicle1" name="chcb1" value="Bike"></center></div><div class="col-sm-2 small" style="margin-top: 8px;margin-left:-20px;"><b>Vendor</b></div><div class="col-sm-1 small" style="margin-top: 8px;margin-left:-20px;"><b>Inv#</b></div> <div class="col-sm-1 small" style="margin-top: 8px;text-align:right;margin-left:30px;"><b>PO$ </b> </div>  <div class="col-sm-1 small" style="margin-top: 8px;text-align:right;"><b>Inv$</b></div><div class="col-sm-1 small" style="margin-top: 8px;text-align:right;"><b> Budget </b></div><div class="col-sm-1 small" style="margin-top: 8px;">  <b>PO Date</b>  </div><div class="col-sm-1 small" style="margin-top: 8px;"> <b> Invoice Date </b> </div><div class="col-sm-1 small" style="margin-top: 8px;"> <a data-type="match"> <b> Match ? </b></a></div><div class="col-sm-1 small" style="margin-top: 8px;">  <b>Pending With  </b></div><div class="col-sm-1 small" style="margin-top: 8px;"><b>Status</b></div>   </div></div>{% for d in data %}  <div class="dashboard-list-item">   <div class="row"> <div class="col-sm-1 small" style="margin-top: 8px;"><center>{%if (((d[4]=="Draft")||(d[4]=="Rejected"))&&(d[10]=="1"||d[10]=="3"))%}<input type="checkbox" id="chcb2" name="chcb2" value="Bike" class="btn-check">{%else%}{%if ((d[4]=="Pending")&&(d[10]=="2"||d[10]=="3"))%}<input type="checkbox" id="chcb2" name="chcb2" value="Bike" class="btn-check">{%else%}<input type="checkbox" id="chcb2" name="chcb2" value="Bike" class="btn-check" disabled>{%endif%}{%endif%}</center></div>  <div class="b">  <div class="col-sm-2 small" style="margin-top: 8px;margin-left:-20px;">     <a data-type="supplier" data-name="{{ d.supplier }}">{{ d[1] }}</a>   </div> </div>  <div class="b">  <div class="col-sm-1 small" style="margin-top: 8px;margin-left:-20px;">          <a data-type="purchase_invoice"       data-name="{{ d.name }}" href="/desk#Form/Purchase%20Invoice/{{ d[0] }}"><div class="b"> <u><input type="text"  value={{ d[0] }} style="color:blue;" id="inv" class="inv"></u></div></a>      </div></div> <div class="b"> <div class="col-sm-1 small" style="margin-top: 8px;text-align:right;margin-left:30px;" word-wrap: break-word;>  {{ d[5] }}  </div> </div>  <div class="b">  <div class="col-sm-1 small" style="margin-top: 8px;text-align:right;"> {{ d[2]}} </div>  </div> <div class="b"> <div class="col-sm-1 small" style="margin-top: 8px;text-align:right;">  {{ d[9] }}  </div></div><div class="b"><div class="col-sm-1 small" style="margin-top: 8px;">  {{d[6]}}  </div> </div><div class="b"><div class="col-sm-1 small" style="margin-top: 8px;">  {{ d[3] }}  </div></div><div class="col-sm-1 small" style="margin-top: 8px;">  <a data-type="match">{%if d[7]==1%}Y{%else%}N{%endif%} </a> </div> <div class="b"><div class="col-sm-1 small" style="margin-top: 8px;">  {{ d[8] }}  </div></div><div class="b"><div class="col-sm-1" style="margin-top: 8px;text-align:left;"> </a>         {%if (d[4]=="To Pay")%} <button  class="btn btn-default btn-xs btn-add btn-success">{{d[4]}} </button>{%else%}{%if (d[4]=="Rejected")%} <button  class="btn btn-default btn-xs btn-add btn-danger">{{d[4]}} </button>{%else%}{%if (d[4]=="Draft")%} <button  class="btn btn-default btn-xs btn-info btn-status">{{d[4]}} </button>{%else%}<button  class="btn btn-default btn-xs btn-add btn-warning">{{d[4]}}</button> {%endif%} {%endif%} {%endif%}</div></div>    </div>  </div> {% endfor %} <dialog id="myDialog">This is an open dialog window</dialog><center><table><tr>{%if (d[10]=="1"||d[10]=="3")%}<td><div class="submit"><button  class="btn btn-default btn-xs btn-submit  button-sbt button">Submit</a>    </div></td>{%endif%}{%if (d[10]=="2"||d[10]=="3")%}<td><div>&nbsp;<button  class="btn btn-default btn-xs btn-approve button-apr button">Approve</a>    </div></td><td><div>&nbsp;<button  class="btn btn-default btn-xs btn-reject button btn-danger">Reject</a>    </div></td>{%endif%}</tr></center>',
