...
function get_paid_invoices(supplier){	
	selections=""
		 let dialogObj= new frappe.ui.form.MultiSelectDialog({
			 ...
			 get_query() {
			 return {
				 filters: {  docstatus: ['=', 1],supplier: ['=', supplier]}
				 }
			 },
			 action(selections) {
			}
