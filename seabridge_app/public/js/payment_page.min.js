...
function t(t,a){
	...
	this.content.on("click",".btn-payment",function(){
		...
		console.log("Total Array---------------",invoices)
		console.log('CompanyIN-------------',e.company)
		console.log('AccountIN-------------',e.account)
...
function get_item_dashboard_data(e,t,a){
	            t||(t=0),e||(e=[]),
	            e.forEach(function(e){
	                e.actual_or_pending=e.projected_qty+e.reserved_qty+e.reserved_qty_for_production+e.reserved_qty_for_sub_contract,
	                e.pending_qty=0,
