	...
	this.content.on("click",".inv",function(){
		...
		frappe.call({method:"seabridge_app.seabridge_app.api.get_invoice_details",
			...
			callback:function(r){
				...
				var po_date='<font style="font-size: 12px;color:#9E9E9E;">PO Date</font><br><label style="background-color: #EDF2F2; color: blue;width: 260px;height: 29px;"><div style="color: blue;padding-top: 5px;padding-bottom: 5px;padding-left: 9px;"></div></label>'
				if(r.message[0][0][6]){
				po_date='<font style="font-size: 11px;color:#9E9E9E;">PO Date</font><br><label style="background-color: #EDF2F2; color: blue;width: 260px;height: 29px;"><div style="color: blue;padding-top: 5px;padding-bottom: 5px;padding-left: 9px;font-size: 12px;">'+r.message[0][0][6]+'</div></label>'
				}
				var po_amount='<font style="font-size: 12px;color:#9E9E9E;">PO$</font><br><label style="background-color: #EDF2F2; color: blue;width: 260px;height: 29px;"><div style="color: blue;padding-top: 5px;padding-bottom: 5px;padding-left: 9px;"></div></label>'
				if(r.message[0][0][5]){
				po_amount='<font style="font-size: 11px;color:#9E9E9E;">PO$</font><br><label style="background-color: #EDF2F2; color: blue;width: 260px;height: 29px;"><div style="color: blue;padding-top: 5px;padding-bottom: 5px;padding-left: 9px;font-size: 12px;">'+r.message[0][0][5]+'</div></label>'
				}
				...
				var invoice_date='<font style="font-size: 12px;color:#9E9E9E;">Invoice Date</font><br><label style="background-color: #EDF2F2; width: 260px;font-size: 16px;"><div style="padding-top: 5px;padding-bottom: 5px;padding-left: 9px;font-size: 12px;">'+r.message[0][0][2]+'</div></label>'
