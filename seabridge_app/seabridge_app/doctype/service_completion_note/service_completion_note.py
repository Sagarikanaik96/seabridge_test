...
class ServiceCompletionNote(BuyingController):
	def __init__(self, *args, **kwargs):
		super(ServiceCompletionNote, self).__init__(*args, **kwargs)
		self.status_updater = [{
	...
	def validate(self):
		...
		super(ServiceCompletionNote, self).validate()
	...
	def validate_with_previous_doc(self):
		super(ServiceCompletionNote, self).validate_with_previous_doc({
			"Purchase Order": {
	...
	# on submit
	def on_submit(self):
		super(ServiceCompletionNote, self).on_submit()
	...
	def on_cancel(self):
		super(ServiceCompletionNote, self).on_cancel()
