frappe.pages['custompage'].on_page_load = function(wrapper) {
	var parent = $('<div class="custompage"></div>').appendTo(wrapper);

	parent.html(frappe.render_template("custompage", {}));
